...
{
    public partial class NewActivationEditView : Form
    {
        ...
        public NewActivation Entity { get; private set; }
        public Adapter Adapter { get; }

        public NewActivationEditView(Adapter adapter, int id, Form owner = null)
        {
            Adapter = adapter;
            this.owner = owner;
            //Owner = owner;
        ...
        {
            if (id == 0) Entity = new NewActivation() { Tax = Properties.Settings.Default.Tax };
            else
            {
                Entity = await Adapter.Retrive<NewActivation>(id);
                if (Entity == null)
                {
                    wait.Close();
                    Message.Stop("No NewActivation found to show.");
                    this.Dispose();
                    return;
                }
            ...
            var polices =
              ...
              .FindAll(x =>
              {
                  return XString.Equal(x.PolicyType.Name, "NewActivation");
              });
        ...
        private void DdlCarrier_TextChanged(object sender, EventArgs e)
        {
        ...
        {
           newActivationBindingSource.Clear();
           newActivationBindingSource.Add(Entity);
        }
        ...
        public void InvalidateForm()
        {
            ...
            if (Entity.IsNew)
            {
                lblTitle.Text = "          New NewActivation";
            ...
            {
                lblTitle.Text = "          Edit NewActivation";
        ...
        private async void BtnFinish_Click(object sender, EventArgs e)
        {
            ...
            if (changes > 0)
            {
                if (Entity.Transactions?.Count == 0) new TransactionView<NewActivation>(Adapter, Entity, TransactionType.Cashin, this);
            }
        ...
        {
            new TransactionView<NewActivation>(Adapter, Entity, TransactionType.Cashin, this);
            BindEntity();
            InvalidateForm();
        ...
        private void PrintReceipt(XPrinter printer)
        {
            ...
            printer.AddString(string.Format("{0,-" + W(15) + "}{1,-" + W(35) + "}{2,-" + W(15) + "}{3,-" + W(35) + "}", "Name", ": "+Entity.FullName, "Phone No", ": " + Entity.Phone), XFont.R8, XFontColor.Black, g: graphics);
            ...
            printer.AddString(string.Format("{0,-" + W(15) + "}{1,-" + W(35) + "}", "Carrier", ": " + Entity.Carrier.Name), XFont.R8, XFontColor.Black, g: graphics);
        ...
        {
            new TransactionView<NewActivation>(Adapter, Entity, TransactionType.Refund, this);
            BindEntity();
            InvalidateForm();
        }
